...
function TrailerSection() {
  ...
  return (
    ...
    <p className='textgray-300 font-medium text-lg max-w-[960px] mx-auto'>Trailers</p>
    ...
    <div className='groups grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
